<?php
 ...
 //-------------------------------------------------------------------------	
	...
	$params = "actionType=PAY&cancelUrl=".$ret."&trackingId=".$trID."&ipnNotificationUrl=".$notifyURL."&currencyCode=".$currency.
  	"&receiverList.receiver(0).amount=".($amount2+$amount1)."&receiverList.receiver(0).email=".$receiver2.
  	"&receiverList.receiver(0).primary=true&receiverList.receiver(1).amount=".$amount1.
  	"&receiverList.receiver(1).email=".$receiver1."&requestEnvelope.errorLanguage=en_US".
  	"&returnUrl=".$ret;
