          ...
          <div class="page">
                ...
                <div id="portfolio-carousel" class="carousel slide" data-ride="carousel">
                  ...
                  <div class="carousel-inner">
                    <div class="item active">
                      <img src="img/sample/elephants-dream/sample-elephants-3.jpg" alt="" title="Elephant's Dream" />
                    </div><!-- end item -->
                    <div class="item">
                      <img src="img/sample/elephants-dream/sample-elephants-2.jpg" alt="" title="Elephant's Dream" />
                    </div><!-- end item -->
                    <div class="item">
                      <img src="img/sample/elephants-dream/sample-elephants-1.jpg" alt="" title="Elephant's Dream" />
                    </div><!-- end item -->
                  </div>
                  <!-- Controls -->
              ...
              <div class="row">
                <div class="col-md-4">
                  <ul class="list-unstyled post-meta">
                    ...
                    <li><a href="#none" class="btn btn-default" id='submit-proposal-id' rel="<?php the_ID(); ?>"><?php _e('Submit a Proposal','ProjectTheme'); ?></a></li>
                  </ul><!-- end post-meta -->
                </div><!-- end col -->
                <div class="col-md-8">
            ...
            <ul class="pager">
              <li class="prev">
                ...
                <h3><a href="#none">Big Buck Bunny</a></h3>
